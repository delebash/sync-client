...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sync_client__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sync_client___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_sync_client__);
...
async function opendb() {
    db = new __WEBPACK_IMPORTED_MODULE_0_sync_client___default.a(DB_NAME, versions);
...
async function edit() {
    try {
        ...
        let friends = await db.test.where("id").equalsIgnoreCase("1").toArray();
        for (let friend of friends) {
...
/* WEBPACK VAR INJECTION */(function(setImmediate, clearImmediate) {module.exports =
/******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
/******/ 	var installedModules = {};
/******/
